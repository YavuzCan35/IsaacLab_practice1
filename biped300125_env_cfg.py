...
class Biped300125RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.events.reset_base.params = {
            "pose_range": {"x": (5.0, 5.0), "y": (14.0, 14.0), "z": (0.5, 0.5), "yaw": (0.0, 0.0)},
            "velocity_range": {
                "x": (0.0, 0.0),
                "y": (0.0, 0.0),
                "z": (0.0, 0.0),
        ...
        # USD terrain (import under /World)
        # self.scene.terrain.prim_path = "/World"
        # self.scene.terrain.terrain_type = "usd"
        # self.scene.terrain.usd_path = r"C:\Users\firstuser\Downloads\newapartmentv3.usd"
        # self.scene.terrain.terrain_generator = None
        # self.scene.terrain.env_spacing = self.scene.env_spacing
        # self.scene.terrain.max_init_terrain_level = None
        # self.curriculum.terrain_levels = None
        # if self.scene.height_scanner is not None:
        #     self.scene.height_scanner.mesh_prim_paths = ["/World/terrain"]

        # USD terrain (import full USD under /World)
        self.scene.terrain.prim_path = "/World"
        self.scene.terrain.terrain_type = "usd"
        self.scene.terrain.usd_path = r"C:\Users\firstuser\Downloads\newapartmentv3.usd"
        self.scene.terrain.terrain_generator = None
